<template>
  ...
  >
    ...
    <div v-else-if="step === 1">
      <div class="flex items-center justify-center text-black space-x-4 my-4">
        <img src="../../assets/podcast_icon.png" alt="" class="w-24 h-24" />
        <h1>Upload Image</h1>
      </div>
      <div class="flex justify-center items-center">
        <d-btn variant="primary" class="mt-2 w-1/4" @click="submitPodcast">
          Finish
        </d-btn>
        <d-btn
          variant="simple-black"
